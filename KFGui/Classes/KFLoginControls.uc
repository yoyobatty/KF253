...
var automated GUIButton b_Team, b_Settings, b_Browser, b_Quit, b_Favs,
              b_Leave, b_MapVote, b_KickVote, b_MatchSetup, b_Spec, b_Perks;
...
function SetupGroups()
{
	...
	if( KFGameReplicationInfo(PC.Level.GRI)==None || !KFGameReplicationInfo(PC.Level.GRI).bPerksEnabled )
		DisableComponent(b_Perks);
	else EnableComponent(b_Perks);
	RemapComponents();
}
...
function bool ButtonClicked(GUIComponent Sender)
{
	...
	{
		Controller.CloseMenu();
		PC.ClientOpenMenu("KFGUI.GUIVeterancyBinder", false); 
	}
	return true;
}
...
defaultproperties
{
     ...
     Begin Object Class=GUIButton Name=PerksMenuButton
         Caption="Perks"
         bAutoSize=True
         WinTop=0.825000
         WinLeft=0.725000
         ...
         TabOrder=9
         OnClick=KFLoginControls.ButtonClicked
         OnKeyEvent=PerksMenuButton.InternalOnKeyEvent
     End Object
     b_Perks=GUIButton'KFGui.KFLoginControls.PerksMenuButton'
