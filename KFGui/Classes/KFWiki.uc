...
if(lb_items.List.index < 9)
{
    ...
    lb_StatBox.SetContent(" Damage Potential - "$CurrentEnemy.default.damageConst$"-"$(CurrentEnemy.default.damageConst + CurrentEnemy.default.damagerand));
...
defaultproperties
{
     ...
     WikiObjectDescription(10)="a length of pipe"
     ...
     WikiObjectClassName(10)="KFMod.Bat"
