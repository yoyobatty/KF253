...
// Dualies Fire
//=============================================================================
class DualMachinePistolsFire extends KFFire;
...
event ModeDoFire()
{
	...
	bn = DualMachinePistols(Weapon).altFlashBoneName;
	DualMachinePistols(Weapon).altFlashBoneName = DualMachinePistols(Weapon).FlashBoneName;
	DualMachinePistols(Weapon).FlashBoneName = bn;
...
defaultproperties
{
    ...
    FireRate=0.0260000
    AmmoClass=Class'KFMod.DualMPistolAmmo'
    AmmoPerFire=1
