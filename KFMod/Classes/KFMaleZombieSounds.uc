class KFMaleZombieSounds extends xPawnSoundGroup;
...
defaultproperties
{
     ...
     PainSounds(0)=Sound'KFPlayerSound.zpain1'
     PainSounds(1)=Sound'KFPlayerSound.zpain2'
     PainSounds(2)=Sound'KFPlayerSound.zpain3'
     PainSounds(3)=Sound'KFPlayerSound.zpain2'
     PainSounds(4)=Sound'KFPlayerSound.zpain1'
     PainSounds(5)=Sound'KFPlayerSound.zpain3'
}
