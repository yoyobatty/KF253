...
//var() float PickupDevaluation; // Multiply the base value of the pickup spawned by this amount. (reduce scavenge-sale cash whoring)
...
function TurnOn()
{
    ...
    */
    ...
    SetTimer(InitialWaitTime, false);
}
...
function SpawnPickup()
{
   ...
   AdjustedRotation.Pitch = rand(10000) + 1000;
    ...
    //    KFWeaponPickup(myPickup).Cost *= PickupDevaluation;
    }
...
function bool PlayersCanSeeMe()
{
  ...
  for( C=level.ControllerList; C!=none; C=C.nextController)
  {
    ...
    {
      if(FastTrace(C.Pawn.Location)==true)
        return true;
    }
  }
