...
defaultproperties
{
	ImpactSounds(0)=Sound'GeneralImpacts.Water.ImpactSplash1'
	ImpactSounds(1)=Sound'GeneralImpacts.Water.ImpactSplash2'
	ImpactSounds(2)=Sound'GeneralImpacts.Water.WaterExit'
	ImpactSounds(3)=Sound'PlayerSounds.BFootsteps.BFootstepWater1'
	ImpactSounds(4)=Sound'PlayerSounds.BFootsteps.FootstepWater1'
	ImpactSounds(5)=Sound'PlayerSounds.BFootsteps.FootstepWater2'
