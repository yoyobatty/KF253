...
function PostBeginPlay()
{
	...
	if ( KFGameType(Level.Game) != none ) {
		...
		KFGameType(Level.Game).MonsterSquad[0]="3A"; // 8 Clots
		KFGameType(Level.Game).MonsterSquad[1]="5A"; // 9 Clots etc.
		KFGameType(Level.Game).MonsterSquad[2]="6A";
		KFGameType(Level.Game).MonsterSquad[3]="6A";
		KFGameType(Level.Game).MonsterSquad[4]="6A";
		KFGameType(Level.Game).MonsterSquad[5]="6A";
		KFGameType(Level.Game).MonsterSquad[6]="6A";
		KFGameType(Level.Game).MonsterSquad[7]="6A";
		KFGameType(Level.Game).MonsterSquad[8]="6A";
		KFGameType(Level.Game).MonsterSquad[9]="6A";
		KFGameType(Level.Game).MonsterSquad[10]="7A";
		KFGameType(Level.Game).MonsterSquad[11]="7A";
		KFGameType(Level.Game).MonsterSquad[12]="8A";
		KFGameType(Level.Game).MonsterSquad[13]="8A";
		KFGameType(Level.Game).MonsterSquad[14]="8A";
		KFGameType(Level.Game).MonsterSquad[15]="8A";
		KFGameType(Level.Game).MonsterSquad[16]="8A";
		KFGameType(Level.Game).MonsterSquad[17]="8A";
		KFGameType(Level.Game).MonsterSquad[18]="8A";
		KFGameType(Level.Game).MonsterSquad[19]="8A";
