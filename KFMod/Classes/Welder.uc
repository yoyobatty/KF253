...
simulated event RenderTexture(ScriptedTexture Tex)
{
	...
	// Tex.TextSize(ScreenWeldPercent,NameFont,SizeX,SizeY);     //Returns the Size needed for this string to ensure it will fit on the space provided
	Tex.DrawTile(0,0,Tex.USize,Tex.VSize,0,0,Tex.USize,Tex.VSize,ScriptedScreenBack,BackColor);   // Draws the tile background
